...
public class BabyBirths {
	...
	public void whatIsNameInYear(String name, int year, int newYear, String gender){
		...
		System.out.println(name + " born in " + year + " would be " + nameinNewYear + " if they was born in " + newYear);
	}
	...
	public static void main(String[] args) {
		...
		// FileResource fr = new FileResource();
		// CSVParser parser = fr.getCSVParser(false);
		//System.out.println("Rank: " + bb.getRank(1994, "Forrest", "M"));
		//System.out.println(bb.getName(1982, 450, "M"));
		//bb.whatIsNameInYear("Isabella", 2012, 2014, "F");
		//bb.testTotalBirths();
		//System.out.println("X was the highest rank in " + bb.yearOfHighestRank("Mich", "M"));
